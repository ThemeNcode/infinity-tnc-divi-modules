 ...
 * @since ??
 *
 * @param {object} props The conversion map props.
 ...
 *
 * @returns {object} Conversion map for AdminLabel options.
 */
export declare const getAdminLabelConversionMap: ({ d4AdvancedOptionName, d5AttrName, d4AttributeSuffix, }: ConversionMapProps) => ModuleConversionMap;
