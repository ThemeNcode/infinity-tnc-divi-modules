 ...
 *
 * @returns {object} Conversion map for position options.
 */
export declare const getPositionConversionMap: ({ d4AdvancedOptionName, d5AttrName, d4AttributeSuffix, }: ConversionMapProps) => ModuleConversionMap;
