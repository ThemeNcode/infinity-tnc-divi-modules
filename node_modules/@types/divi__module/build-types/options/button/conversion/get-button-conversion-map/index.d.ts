 ...
 *
 * @returns {object} Conversion map for Button options.
 */
export declare const getButtonConversionMap: ({ d4AdvancedOptionName, d5AttrName, d4AttributeSuffix, }: ConversionMapProps) => ModuleConversionMap;
