 ...
 *
 * @returns {object} Conversion map for FormField options.
 */
export declare const getFormFieldConversionMap: ({ d4AdvancedOptionName, d5AttrName, d4AttributeSuffix, }: ConversionMapProps) => ModuleConversionMap;
