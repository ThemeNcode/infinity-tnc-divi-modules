...
import { LogoCarouselEditProps, LogoCarouselInnerContent } from './types';
...
export const LogoCarouselEdit = (props: LogoCarouselEditProps): ReactElement => {
  const {
    attrs,
    elements,
    id,
  ...
  return (
    ...
    >
      ...
      <div className="inftnc_carousels_logo_wrapper" style={ { '--inftnc-slide-gap': slideSpacing } as React.CSSProperties }>
