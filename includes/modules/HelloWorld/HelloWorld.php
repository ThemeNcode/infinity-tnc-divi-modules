...
class INFTNC_HelloWorld extends ET_Builder_Module {

	public $slug       = 'inftnc_hello_world';
	...
	public function init() {
		$this->name = esc_html__( 'Hello World', 'inftnc-infinity-tnc-divi-modules' );
	}
