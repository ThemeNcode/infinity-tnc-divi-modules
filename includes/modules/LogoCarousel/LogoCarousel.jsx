...
//  }
  ...
  render() {
    ...
    var settings = { 
      ...
      //prevArrow: '<button type="button" className="slick-inftnc-arrow slick-prev" data-icon="&#x34;"></button>',
      //nextArrow: '<button type="button" className="slick-inftnc-arrow slick-next" data-icon="&#x35;"></button>',
      responsive: [
        {
          breakpoint: 1024,
          settings: {
