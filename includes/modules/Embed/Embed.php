...
class INFTNC_EmbedIframe extends ET_Builder_Module {

	public $slug       = 'inftnc_embed_iframe';
	...
	public function init() {
		$this->name = esc_html__( 'Embed(Map,Video)', 'inftnc-infinity-tnc-divi-modules' );
	}
